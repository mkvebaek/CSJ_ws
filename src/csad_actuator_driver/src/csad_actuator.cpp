...
int fd_;
double servoOffsets[] = {-0.42f, -0.12f}; // The offset in the first element here corresponds to the offset of the servo with the id matching the first element of servoIds
int servoIds[] = {1, 2};
